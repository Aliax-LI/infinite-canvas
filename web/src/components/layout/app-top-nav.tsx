...
import { canAutoConnectLocalAgent } from "@/lib/agent/local-agent-connect-policy";
...
export function AppTopNav() {
    ...
    useEffect(() => {
        ...
        if (!canAutoConnectLocalAgent(agentUrl)) return;
        autoConnectRef.current = true;
        connectAgent({ silent: true });
    }, [agentConnected, agentEnabled, agentToken, agentUrl, connectAgent]);
