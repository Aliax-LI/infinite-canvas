export default {
    ...
    prompts: {
        ...
        searching: "Searching. The first load of a large source may take a moment",
        loadingCatalog: "Loading the remaining sources…",
    ...
    imageWorkbench: {
        ...
        emptyHint: "Describe the image in the bar below and press Enter. References, the prompt library, and settings live in the composer.",
        fillComposer: "Fill the composer",
    ...
    config: {
        ...
        sub2apiImporting: "Syncing Sub2API provider…",
        sub2apiImportFailed: "Failed to create a Sub2API key or import the provider",
        sub2apiExistingKeyNoSecret: "A 「无限画布」 key already exists on Sub2API but the secret is unavailable. Open in a browser that imported it before, or enter the API key in settings.",
        sub2apiGroupPickerTitle: "Choose a Sub2API group",
        sub2apiGroupPickerDescription: "The first embed needs a new 「无限画布」 API key. Pick which group it belongs to.",
        sub2apiGroupPickerAssignDescription: "The 「无限画布」 API key has no group yet. Choose a group to continue importing.",
        sub2apiGroupPickerAssignConfirm: "Bind and import",
        sub2apiGroupsLoadFailed: "Could not load Sub2API groups. Reopen the embed link from Sub2API or add group_id to the URL.",
        sub2apiGroupPickerPlaceholder: "Select a group",
        sub2apiGroupPickerConfirm: "Create and import",
        sub2apiGroupRequired: "Select a group first",
        sub2apiGroupFallbackName: "Group #{{id}}",
